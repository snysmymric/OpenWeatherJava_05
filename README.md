...
<p>2. Copy the HTTPS project link from the GitHub repository:&nbsp;<br /><a href="https://github.com/saginayeva/OpenWeatherProject.git">https://github.com/saginayeva/OpenWeatherProject.git</a></p>

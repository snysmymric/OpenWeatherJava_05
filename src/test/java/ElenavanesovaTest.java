...
public class ElenavanesovaTest extends BaseTest {
    ...
    final static By H_2_CITY_NAME_HEADER = By.xpath( "//div[@id = 'weather-widget']//h2");
    ...
    private void waitForGrayFrameDisparaged(){
    ...
    public void testH2TagText_WhenSearchingCityCountry() {
        ...
        openBaseURL();
        waitForGrayFrameDisparaged();

        String oldH2Header = getText(H_2_CITY_NAME_HEADER,getDriver());
        ...
        waitTextToBeChanged(H_2_CITY_NAME_HEADER, oldH2Header, getDriver(), getWait10());


        String actualResult = getText(H_2_CITY_NAME_HEADER, getDriver());

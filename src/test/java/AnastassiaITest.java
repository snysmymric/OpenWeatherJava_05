...
public class AnastassiaITest extends BaseTest {
    ...
    private final  By SEARCH_CITY_FIELD = By.xpath("//div[@id = 'weather-widget']/div/div/div//div/div/input[@placeholder = 'Search city' ]");
    ...
    public void testH2TagText_WhenSearchingCityCountry() {
        ...
        String actualCityCountryNames = getText(H_2_CITY_COUNTRY_HEADER);
